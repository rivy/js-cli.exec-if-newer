...
const modulePath = '../dist/cli/exec-if-updated.js';
...
test.beforeEach(() => {
	mock({
		source: mock.file({ content: '*source file*', mtime: new Date(1000) }),
		source_early: mock.file({ content: '*source file*', mtime: new Date(500) }),
		source_later: mock.file({ content: '*source file*', mtime: new Date(1500) }),
		target: mock.file({ content: '*target file*', mtime: new Date(1000) }),
		target_early: mock.file({ content: '*target file*', mtime: new Date(500) }),
		target_later: mock.file({ content: '*target file*', mtime: new Date(1500) }),
	});
});
